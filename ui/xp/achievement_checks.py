...
from db.xp import get_total_xp, level_for_total_xp, count_xp_events_by_type, has_xp_event_in_hours, has_xp_event_on_weekend
...
def check_todo_count(n: int):
    return lambda c, day=None: count_xp_events_by_type(c, "todo_completed") >= n
...
CHECKS = {
    ...
    "level_10": check_level_at_least(10),
    ...
    "journal_7": check_journal_count(7),
